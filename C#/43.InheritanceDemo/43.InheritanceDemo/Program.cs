...
namespace _43.InheritanceDemo
{
    ...
    { 
        public Benz() : this(CarType.내연기관) { }  // 생성자 포워딩
        public Benz(CarType carType) : base(carType) { }  // 부모 클래스의 생성자로 전송
        
    }
    

    public class Tesla : Car // Child : parent, Chile extends Parent
    {
